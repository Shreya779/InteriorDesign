...
$sql = "SELECT * FROM form_living_room ORDER BY id DESC LIMIT 1"; // Assuming id is the primary key and auto-incremented
...
if ($result->num_rows > 0) {
    ...
    if ($result_user->num_rows > 0) {
        ...
        echo "<h2><center>Thank you, we will get back to you soon</center></h2>";
        echo "<p><strong>Width:</strong> $width</p>";
        echo "<p><strong>Length:</strong> $length</p>";
        echo "<p><strong>Sofa type:</strong> $sofa_type</p>";
        echo "<p><strong>Furniture type:</strong> $furniture</p>";
        echo "<p><strong>Lighting type:</strong> $lighting</p>";
